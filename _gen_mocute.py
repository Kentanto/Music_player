...
code = b'''"""MOCUTE-052 / S23-AUTO raw input handler.
    ...
    class _WindowsMocuteFilter(QAbstractNativeEventFilter):
        ...
        def _on_keydown(self, msg):
            ...
            if action:
                self._listener._dispatch(action)
                return True, 1
            return True, 1   # swallow unknown keys so they do not leak to Qt
...
with open(r'c:\Users\olaib\Music_platform\mocute_listener.py', 'wb') as f:
    f.write(code)
